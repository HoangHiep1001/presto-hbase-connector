...
public class HBaseColumnMetadata extends ColumnMetadata {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(family, Utils.mapField.get(getName()), getType(), getComment(), getExtraInfo(), isHidden());
    }
    ...
    public boolean equals(Object obj) {
        ...
        return Objects.equals(Utils.mapField.get(getName()), Utils.mapField.get(other.getName())) &&
