 ...
 */
package com.analysys.trino.connector.hbase.meta;
...
import com.analysys.trino.connector.hbase.utils.Types;
...
public class HBaseMetadata implements ConnectorMetadata {
    ...
    public ColumnMetadata getColumnMetadata(ConnectorSession connectorSession,
        ...
        Types.checkType(connectorTableHandle, HBaseTableHandle.class, "tableHandle");
        return Types.checkType(columnHandle, HBaseColumnHandle.class, "columnHandle").toColumnMetadata();
    }
    ...
    private HBaseTableHandle fromConnectorTableHandle(ConnectorTableHandle tableHandle) {
        return Types.checkType(tableHandle, HBaseTableHandle.class, "tableHandle");
    }
    // ----------------------------------- end insert -----------------------------------
    ...
    public ColumnHandle getUpdateRowIdColumnHandle(ConnectorSession session, ConnectorTableHandle tableHandle) {
        ...
        return new HBaseColumnHandle(Constant.CONNECTOR_NAME, "",
