...
public class Utils {
    ...
    public static HashMap<String, String> mapField = new HashMap<>();
    ...
    public static ImmutableList<ColumnMetadata> getColumnMetaFromJson(String schemaName, String tableName, String metaDir) {
        ...
        try {
            ...
            for (int i = 0; i < cols.length(); i++) {
                ...
                mapField.put(columnName.toLowerCase(Locale.ENGLISH), columnName);
     ...
     * @param tableName  table name
     * @param metaDir    meta dir
     * @return map of column name (because case not a normalize of hbase column name)
     */
    public static HashMap<String, String> getMapField(String schemaName, String tableName, String metaDir) {
